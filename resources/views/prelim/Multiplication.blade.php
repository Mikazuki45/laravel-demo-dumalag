...
<head>
    ...
    <title>MultiplicationSansan</title>
...
<body>
    ...
    <div class="mx-auto text-center">
        <h1 class="font-bold mt-5">This is the Addition Page</h1>
        <form action="{{ route('calculatemul') }}" class="mt-5" method="POST">
            @csrf
        ...
        @if($result != null)
            <span class="text-xl">Total: {{ $result }}</span>
        @endif
    </div>
